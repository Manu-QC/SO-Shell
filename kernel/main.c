...
int kernel_main()
{
	...
	console_putchar(console, 'a');
	console_putchar(console, 'u');
	console_putchar(console, 't');
	console_putchar(console, 'o');
	console_putchar(console, 'm');
	console_putchar(console, 'o');
	console_putchar(console, 'u');
	console_putchar(console, 'n');
	console_putchar(console, 't');
